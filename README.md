...
This code efficiently processed a very large set of collected data, and was responsible for the extraction of all three ASR features for further analysis in MATLAB and Excel.
